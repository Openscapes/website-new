...
We are funded through grants and contracts with our partners, which supports investment in [our flywheel](about.qmd#openscapes-flywheel) to iterate our [initiatives](initiatives.qmd) and share stories through [blogs](blog.qmd) and [media](media.qmd). We are grateful for our funding partners and the broader open community that supports tooling, people, and communities. 

Openscapes launched in 2018 through funding from [Mozilla](https://www.mozilla.org/), via an Open Science Fellowship awarded to Julia Stewart Lowndes. Mozilla also sponsored the [first Champions Cohort](events/2019-01-21-inaugural/index.Rmd) for seven academic science teams. Early funders also include the [Gordon and Betty Moore Foundation](https://www.moore.org/), who supported us to develop a strategic growth plan, and [Code for Science and Society](https://eventfund.codeforscience.org/), who supported us to improve daily practices for how we work and teach to more bravely align with our values for diversity, equity, inclusion, and belonging. 
...
The Openscapes website was originally built by [Julia Stewart Lowndes](https://jules32.github.io/) with [RMarkdown's blogdown](https://pkgs.rstudio.com/blogdown/) using the same open data science workflows used for research. The website was rebuilt by [Samantha Csik](https://samanthacsik.github.io/), Julie Lowndes, and [Stefanie Butland](https://stefaniebutland.netlify.app/) in spring 2023 with [Quarto](https://quarto.org/), a new open-source, scientific and technical publishing system the Openscapes community has used since its earliest days (see [quarto blog posts](blog.qmd#category=quarto)).
