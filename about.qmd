...
We are dedicated to leading Openscapes as an open source community. This includes exploring and growing mechanisms to administer funding for people building careers in open science. Funding was first administered through [NCEAS](https://nceas.ucsb.edu), and [Open Collective](https://opencollective.com). It is currently administered via [Openscapes LLC](https://jules32.github.io/openscapes-llc), a certified women-owned small business and [1% for the Planet](https://www.onepercentfortheplanet.org/) member.
