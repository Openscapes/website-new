...
::: {.column-screen}
![TODO: Rename to "About Us"](images/banner_imgs/text_banners/who_are_we_banner.png)

<br>

::: {.white-div}
::: {.medium-body-text .center-text}
**We are researchers who found open practices to be so game-changing that we are dedicating our careers to empowering others and growing the movement**
:::
