...
::: {.column-screen}
![TODO: UPDATE TO 'OUR APPROACH'](images/banner_imgs/text_banners/champions_program_banner.png)
...
We know that daily demands leave little time to transition to better data practices and open science, which can be lonely and overwhelming. Openscapes helps shift culture by mentoring researchers to move from lonely science as they skillbuild and navigate the open science landscape safely with their teams. 
...
We approach open science as a spectrum, a behavior change, and a movement where there are many ways to practice open science and to welcome others to participate. We are influenced and inspired by many leaders and community organizers, particularly in climate and get out the vote movements.
