...
![](zenodo-openscapes-community.png){fig-alt="screenshot of the Openscapes Community page on Zenodo" width="70%" fig-align="center"}
...
![](zenodo-orcid.png){fig-alt="screenshot showing zenodo record called 3 Approaches for the Year of Open Science with green ID symbol linked with an arrow to a second screenshot showing the ORCID record for that publication" width="50%" fig-align="center"}
