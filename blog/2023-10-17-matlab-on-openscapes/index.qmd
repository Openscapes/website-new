...
-   MATLAB desktop: A full MATLAB, including the IDE (bring your own license)
...
In addition, we've written a detailed tutorial to help users learn the system and process the data. The MATLAB tutorial includes code examples, that cover:
...
You can find the MATLAB tutorial on the NASA Openscapes GitHub repo here: <https://nasa-openscapes.github.io/earthdata-cloud-cookbook/in-development/matlab.html>
