...
![](matlab-launch.png){fig-alt="JupyterHub interface with folders listing on left and launcher window on right including 3 rows of icons. Top row inludes MATLAB launcher" width="75%" fig-align="center"}
...
![](matlab-map.png){fig-alt="Map showing sea surface temperature in yellow, green, blue. Heading 'sea surface temperature [kelvin]'; x-axis from 24 to 44; y-axis from -80 to -50" width="75%" fig-align="center"}
