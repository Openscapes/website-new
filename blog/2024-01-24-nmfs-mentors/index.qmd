...
::: {.center-text}
![Word cloud created during a cohort call that depicts topics and skills participants wanted to focus on as part of the NOAA Fisheries Openscapes Mentors program.](word-cloud.png){width="85%" fig-alt="alt text goes here"}
:::
...
::: {.center-text}
![Example of some of the NOAA Fisheries Openscapes Mentors Seaside Chat discussion themes and topics.](seaside-chat-themes.png){width="85%" fig-alt="alt text goes here"}
:::
