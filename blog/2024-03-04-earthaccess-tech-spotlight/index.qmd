...
![`earthaccess` eliminates the need to know the intricacies of NASA’s Application Programming Interfaces (APIs) and cloud data storage systems.](earthaccess-tech-spotlight-intro.png){fig-alt="alt text" fig-align="center" width="85%"}
...
![The `earthaccess` design came from learning/responding to researcher pain points from cross-DAAC Hackathons and Champions Cohorts](earthaccess-tech-spotlight-hackathon.png){fig-alt="alt txt" fig-align="center"}

![This community strategy is a theme and enabler of `earthaccess` growth and utilization.](earthaccess-tech-spotlight-community-strategy.png){fig-alt="alt txt" fig-align="center"}
...
![`earthaccess` interfaces between DAACs-AWS and open science community resources.](earthaccess-interface-daacs-open-community.png){fig-alt="alt txt" fig-align="center"}
