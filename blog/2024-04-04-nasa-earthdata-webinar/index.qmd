...
![Like a spiralling shell, we co-developed across different teams of people that work with NASA Earthdata](nasa-openscapes-shell.png)
...
Cassie screenshared a live walk-through of the [NASA Earthdata Cloud Cookbook](https://nasa-openscapes.github.io/earthdata-cloud-cookbook)

::: blockquote-blue
> *"quote Cassie"* - **Cassie Nickles, Physical Oceanography Data Active Archive Center (PO.DAAC)**
:::

![Slide from Cassie showing the NASA Earthdata Cloud Cookbook](cookbook-screenshot.png)
