...
categories: [blog, nasa-framework, noaa-fisheries, conference]
#image: TODO
---
...
-   [*AGU meeting December 2024*](https://www.agu.org/annual-meeting)
-   Openscapes activities: [https://github.com/NASA-Openscapes/2024-agu-planning](https://github.com/NASA-Openscapes/2024-agu-planning/)

------------------------------------------------------------------------

## The Serviceberry

On the plane home I read [The Serviceberry](https://www.robinwallkimmerer.com/books) , "a bold and inspiring vision for how to orient our lives around gratitude, reciprocity, and community, based on lessons of the natural world". This is a new short book by [Dr. Robin Wall Kimmerer](https://www.robinwallkimmerer.com/), and the physical book was a gift of reciprocity given to me by a colleague-friend and fellow resident of Santa Barbara, Bruce Caron, in exchange for me bringing EarthArxiv community stickers to AGU.
...
-   **Openscapes Social** on Monday. Wow. Such a joy to be with folks in person; the picture below didn’t capture everyone but a lot of us! I was so buoyed to see so many people (\~30 throughout the evening) at a funky bar all together, sharing stories and ideas. There were Mentors from NASA and NOAA, Openscapes Champions from several different years, contributors to `earthaccess` and other open source projects, Pangeo folks, and I met many for the first time! A heart-felt thank you to the anonymous generous person who opened a bar tab for us before we arrived. That speaks volumes about this community and how we share with each other with joy. Thank you!

![Openscapes social on Monday night](Openscapes-Social-AGU-2024.jpg){fig-alt="photo of 20 smiling women and men inside a restaurant" fig-align="center" width="514"}
...
![Julie Lowndes with open science heroes Tasha Snow, Brianna Pagán, Chelle Gentemann, Eli Holmes](open-sci-heroines-agu2024.jpg){fig-alt="selfie of 5 women, with joy on their faces, each with an arm around the person next to them" fig-align="center" width="366"}
...
![Ayush Nag presenting his merged contribution to \`earthaccess\`, as Luis López looks on](ayush-nag-luis-lopez-demo-earthaccess.jpg){fig-alt="photo of informal classroom-like setting with speaker standing facing projected image of a plot, 7 people seated watching and one man standing in the foreground facing the speaker with his back to photographer. He's wearing a cool yellow shirt with green palm leaves" fig-align="center" width="439"}
...
![Aaron Friesz and Eli Holmes zooming around on ebikes](eli-aaron-citibikes-agu2024.jpg){fig-alt="selfie of a woman and man, sitting on bikes that are out of view, in front of a white building and a tree and street signs. Dark outside. Colored lights in the background." fig-align="center" width="294"}
