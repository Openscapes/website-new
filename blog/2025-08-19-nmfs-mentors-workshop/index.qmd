...
The group who maintains or contributes to the centralized [asar](#0) and [stockplotr](#0) R packages for automated stock assessment reports used the time for a collaborative code cleanup.
