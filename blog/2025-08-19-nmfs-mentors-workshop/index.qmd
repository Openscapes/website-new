...
::: {style="text-align:center;"}
![*Working together during a co-creation block.*](cocreation-huddle.jpg){fig-align="center" fig-alt="4 women sit around a table, concentrating with laptops open." width="50%"}
:::
...
A group of people who maintain or contribute to the centralized [asar](https://nmfs-ost.github.io/asar/) and [stockplotr](https://nmfs-ost.github.io/stockplotr/) R packages for automated stock assessment reports used the time for a collaborative code cleanup.
