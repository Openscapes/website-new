...
::: {style="text-align:center;"}
![Major milestones in testing Google Cloud Workstations for MSE, listed as Issues (left) they identified and their current solutions (right).](MSE-cloud-pathway-milestones-tommasi-brooks-norelli.png){fig-alt="text to describe the image" fig-align="center" width="80%"}
:::
...
::: {style="text-align:center;"}
![Procurement for field camp prep and gear purchasing workflows, from a manual and siloed process to a future integrated and automated system.](prep-and-gear-purchasing-workflows-kozama.png){fig-alt="text to describe the image" fig-align="center" width="80%"}
:::
...
::: {style="text-align:center;"}
![Interactive Cumulative Catch Dashboard developed using Shiny.](Cumulative-Catch-Dashboard-brett-cooper.png){fig-alt="text to describe the image" fig-align="center" width="80%"}
:::
...
::: {style="text-align:center;"}
![Progress report on communication for Community Social Vulnerability Indicators](Community-Social-Indicators-Pathways-cameron-speir.png){fig-alt="text to describe the image" fig-align="center" width="80%"}
:::
