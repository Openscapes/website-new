...
::: {style=""}
![Video conference screen shot of NASA Openscapes Champions Cohort.](./zommie.png){fig-alt="video conference participants in grid. People are smiling and waving" fig-align="center" width="60%"}
:::
...
::: {style=""}
![Enhanced metadata workflow for suborbital data.](./SuborbitalMetadata.png){fig-alt="Conceptual flowchart showing enriched metadata about the platform, campaign, provenance, and measured variables associated with suborbital data granules. The granule metadata is represented using UMM-G, connected with GCMD terminology, and submitted to NASA’s Common Metadata Repository." fig-align="center" width="60%"}
:::
