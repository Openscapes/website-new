...
earthaccess is a community-driven Python library that enables access to NASA’s Earth science data with just a few lines of code. (https://earthaccess.readthedocs.io) \| Line Block \| Spaces and newlines \| are preserved [earthaccess is a community-driven Python library that enables access to NASA’s Earth science data with just a few lines of code. (https://earthaccess.readthedocs.io)]{.smallcaps}\
