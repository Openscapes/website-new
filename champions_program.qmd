...
*In the the open data science landscape, there are many paths forward. Through the Champions program we help researchers move from lonely research to team science with community through exploring and navigating pathways together. Artwork by [Allison Horst](https://twitter.com/allison_horst).*
:::
...
:::
::: {.center-text}
Explore the [Champions Lesson Series](https://openscapes.github.io/series/), which introduces the concepts, tooling, and examples that are discussed during Champions Program Cohort Calls. These materials are improved iteratively and the most recent version is always available online for reuse and remix.
:::
:::
...
Explore previous [Openscapes Champions Cohorts](events.qmd) to learn about these inspiring teams' research and open data science momentum.
