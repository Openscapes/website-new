...
## {{< fa pencil title="A pencil" >}} Check out our current projects
...
## {{< fa twitter title="The Twitter logo, a bird" >}} Follow us on Twitter @openscapes
...
## {{< fa envelope title="An envelope" >}} Join our mailing list
...
## {{< fa chalkboard-user title="A person in front of a chalkboard" >}} Join an upcoming event
...
## {{< fa users title="Three people" >}} Book a Champions Cohort
...
## {{< fa people-carry-box title="Two people carrying a large box together" >}} Sponsor Champions Cohorts and Workshops
...
## {{< fa laptop-code title="An open laptop computer with the code symbol, </>, on the screen" >}} Talk with your colleagues
...
## {{< fa bullhorn title="A bullhorn" >}} Amplify through media and events
...
## {{< fa lightbulb title="A lightbulb" >}} Email us with your ideas
